...
import com.example.sca.Homepage.DriverHomePageActivity;
                            ...
                            userAccRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    if(dataSnapshot.hasChild(accountType) &&
                                        ...
                                        Toast.makeText(DriverLoginActivity.this, "Login successful",
                                                Toast.LENGTH_SHORT).show();
                                        startActivity(new Intent(DriverLoginActivity.this,
                                                DriverHomePageActivity.class));
                                        finish();
                                    }
                                    else{
                                ...
                                public void onCancelled(@NonNull DatabaseError error) {
                                    Toast.makeText(DriverLoginActivity.this, "Database error",
                                            Toast.LENGTH_SHORT).show();
                                }
                            });
